...
\centering
\small
\caption{Stage 2 grounding on AITW \texttt{all\_with\_coords} (n$_{\text{train}}$=1200, n$_{\text{val}}$=250, 5 seeds). Mean $\pm$ std over seeds; $\Delta$ vs.\ A with a 95\% cluster-bootstrap CI over validation examples (all seeds of an example kept together; stars from the same bootstrap, $^{*}p<.05$, $^{**}p<.01$, $^{***}p<.001$) and the seed-level paired $t$-test $p$.}
\label{tab:headline}
