...
\author{Aadi Chauhan \quad Arthur Ilyasov \quad Nevin Kunampuram\\
Stanford University\\
{\tt\small \{aadic, ailyasov, nevink\}@stanford.edu}
}
...
\begin{figure}[t]
\begin{center}
\includegraphics[width=0.98\linewidth]{results/phase3/stage1_mind2web_vs_aitw.png}
\end{center}
...
\begin{figure}[t]
\begin{center}
\includegraphics[width=0.98\linewidth]{results/phase4/ablation_ABCD_all_with_coords.png}
\end{center}
...
\begin{figure}[t]
\begin{center}
\includegraphics[width=0.98\linewidth]{results/phase4/compounding_error_per_class.png}
\end{center}
...
\begin{figure}[t]
\begin{center}
\includegraphics[width=0.98\linewidth]{results/phase4/scaling_curve.png}
\end{center}
